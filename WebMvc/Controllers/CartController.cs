...
namespace WebMvc.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(ICartService cartService, ICatalogService catalogService, IIdentityService<ApplicationUser> identityService)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> AddToCart(EventType productDetails)
        {
            try
            {
